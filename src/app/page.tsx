...
import { SITE_NAME, MARKETPLACE_SECTIONS } from "@/lib/constants";
import { getListingsInCategory } from "@/lib/services/listings";
import { Tag, Gavel, TrendingUp, Shield, ArrowRight } from "lucide-react";
...
export default async function HomePage() {
  const [listings, commercial, services] = await Promise.all([
    getFeaturedListings(),
    getListingsInCategory("commercial-equipment", 4),
    getListingsInCategory("services", 4),
  ]);
  ...
  return (
    <div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-lg text-blue-100">
              Products, commercial equipment, and professional services — all in one marketplace.
            </p>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {MARKETPLACE_SECTIONS.map((section) => (
            <Link
              ...
              className="group rounded-2xl border border-gray-200 bg-white p-8 shadow-sm transition hover:border-blue-300 hover:shadow-md"
            >
      ...
      <SectionBlock
        ...
        href="/category/commercial-equipment"
        listings={commercial.listings}
        emptyMessage="No commercial equipment listed yet."
      />
      ...
      <SectionBlock
        ...
        href="/search"
        listings={listings}
        emptyMessage={`No listings yet. Be the first to sell on ${SITE_NAME}!`}
      />
    </div>
  );
}
